 ...
 * 
 * @throw Никаких исключений не генерирует
 * 
 ...
 * 
 * @throws Может генерировать исключения при вызове методов dequeue() или peek()
 *         на пустой очереди (если так реализовано в Queue)
 * 
 * @note Программа создает несколько очередей для демонстрации различных операций
 * @note Каждый этап демонстрации сопровождается выводом в консоль
 */
int main()
{
